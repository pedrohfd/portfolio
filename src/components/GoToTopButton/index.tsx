...
export const GoToTopButton = ({ theme }: GoToTopButtonProps) => {
  ...
  return (
    <motion.button
      className='fixed z-10 flex items-center justify-center w-16 h-16 transition-colors rounded-full bottom-6 right-6 bg-neutral-800 dark:bg-zinc-50'
    ...
    >
      ...
      >
        <motion.circle
          ...
          r='30'
          fill='none'
          className='transition-colors stroke-2 stroke-zinc-50 dark:stroke-neutral-800'
