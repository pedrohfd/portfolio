...
export const AboutSection = () => {
  return (
    <div className='px-12 pt-20 transition-colors bg-zinc-50 dark:bg-neutral-800'>
      <section>
        <h1 className='w-24 text-5xl transition-colors font-familjen text-zinc-800 dark:text-zinc-50'>
          A bit about me
        </h1>

        <HandwriteArrow className='h-12 transition-colors w-52 text-zinc-800 dark:text-zinc-50' />
      </section>

      <p className='mt-10 text-xl text-justify transition-colors font-inter text-zinc-700 dark:text-zinc-100'>
